Rem
Rem $Header: ntoramts/admin/oramtsadmin.sql /main/8 2019/02/13 13:53:21 vraja Exp $
Rem
Rem oramtsadmin.sql
Rem
...
Rem    vraja       10/09/18 - bug28718469: grant "CREATE JOB" privilege to admin
...
grant create job to &mtsadm_usr;
